...
- The silvopastoral at Achotines saw recent cow activity, while at Venoa has ongoing horse activity. The pasture at Achotines has already been planted by Pro Eco Azuero, and hasn't had cows in about a year. The pasture at Venao has frequent ongoing cow activity and cow patties really close to subsampling locations.
- Each sample is a composite of three sub-samples collected 5m apart along a N-S transect and homogenized in the field, in an attempt to avoid micro-climate variability. 
- I also collected litter samples and extracted invertebrates from those, but did not have time to identify them (litter samples tend to take longer)
