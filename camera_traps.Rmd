...
paths <- c("media/Camera traps/11200013.jpg","media/Camera traps/IMG_0057.jpg")
pixgallery(paths)
```
...
```{r, echo=FALSE, message = FALSE, warning = FALSE}
paths <- c("media/Camera traps/12040081.jpg",
...
```{r, echo=FALSE, message = FALSE, warning = FALSE}
paths <- c("media/Camera traps/DSC00968.jpg",
           "media/Camera traps/DSC00946.jpg",
           "media/Camera traps/DSC00953.jpg",
           "media/Camera traps/DSC00906.jpg",
           "media/Camera traps/DSC00946.jpg",
           "media/Camera traps/DSC00915.jpg")
